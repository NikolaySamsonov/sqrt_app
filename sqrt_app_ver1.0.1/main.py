...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        self.cmb_lang.set(self.var_lang.get())
    ...
    def _apply_dark_theme(self):
        ...
        style.map(
            "TCombobox",
            fieldbackground=[("readonly", self._dark_entry)],
            background=[("readonly", self._dark_entry)],
            foreground=[("readonly", self._dark_fg)],
        )
